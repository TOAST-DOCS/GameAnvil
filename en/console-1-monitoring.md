...
- Machine
  ...
  - Redirects to the '[System monitoring ](#system-monitoring)' page through the Monitor button.
- Instance
  ...
  - Redirects to the '[Instance monitoring ](#instance-monitoring)' page through the Monitor button.
- User
...
- GATEWAY
  ...
  - Redirects to the '[GATEWAY node monitoring ](#gateway)' page through the Monitor button.
- GAME
  ...
  - Redirects to the '[GAME node monitoring ](#game)' page through the Monitor button.
- SUPPORT
  ...
  - Redirects to the '[SUPPORT node monitoring ](#support)' page through the Monitor button.
- MATCH
  ...
  - Redirects to the '[MATCH node monitoring ](#match)' page through the Monitor button.
...
`<span style='color: #EB4927'>`①With the graph, the user distribution per machine, instance, and node can be checked through tab`<span style='color: #EB4927'>`①.
...
Up to 50 pieces of data are shown in the graph by default. To display more than 50 items, use 'Show More'`<span style='color: #EB4927'>`②.
...
#### Action`<span style='color: #EB4927'>`①
...
#### Upload files to be deployed`<span style='color: #EB4927'>`②
...
- MATCH
  ...
  - Displays '-' if there is no corresponding node
- Instance status
  - In 'Error' status, click 'Error'`<span style='color: #EB4927'>`③ to check the detailed error message.
- Deployment status
  - In 'Error' status, click 'Error'`<span style='color: #EB4927'>`③ to check the detailed error message.
- Action
