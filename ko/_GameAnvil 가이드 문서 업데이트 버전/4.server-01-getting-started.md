...
GameAnvil 프로젝트에는 라이브러리를 임포트 하는 것 외에도 필수적으로 설정 파일이 필요하고, 직렬화 객체를 위한 컴파일러도 필요합니다. 이런 과정들을 자동으로 처리하고 GameAnvil 서버 프로젝트를 쉽게 구성하기 위해서 IntelliJ템플릿을 이용할 수 있습니다. 템플릿을 이용하기 위해서는 파일을 다운로드 받고 적용하는 과정이 필요합니다. 우선 아래의 설정 파일을 다운로드 받습니다.

[GameAnvil 템플릿 다운로드](http://static.toastoven.net/prod_gameanvil/files/GameAnvil Template.zip?disposition=attachment)

다운로드 받은 템플릿을 적용하기 위해서는 IntelliJ를 실행한 후, InteliJ에서 단축키 `Shift Shift` 로 전체 검색창을 띄운 다음 `Import Settings...` 을 검색합니다. 또는 File > Manage IDE Settings > Import Settings...를 선택합니다.

<img src="http://static.toastoven.net/prod_gameanvil/images/tutorial/search_import_settings.png" />

파인더 창이 뜨면 다운로드 받은 템플릿 파일을 선택합니다. 임포트할 요소들을 선택하는 창이 뜨면, 파일 템플릿과 프로젝트 템플릿을 모두 체크한 후 임포트합니다. 가져오기가 완료되면 InteliJ를 다시 시작합니다.

<img src="http://static.toastoven.net/prod_gameanvil/images/tutorial/select_import.png" />

새로운 프로젝트 생성 창에서 좌측 메뉴의 User-defined탭에서 GameAnvil Template를 선택합니다.

<img src="http://static.toastoven.net/prod_gameanvil/images/new_project_project_template.png" />

GameAnvil 서버를 바로 시작할 수 있는 프로젝트가 생성됩니다. 

<img src="http://static.toastoven.net/prod_gameanvil/images/project_template_view.png" />

GameAnvil에서 제공하는 기능들을 상속받아 사용하기 위해서 파일 템플릿도 제공하고 있습니다. 파일 템플릿을 이용하기 위해서는 프로젝트의 java 폴더에서 우클릭으로 컨텍스트 메뉴를 엽니다. 다양한 파일 템플릿 중 필요한 것을 선택해서 사용할 수 있습니다.

<img src="http://static.toastoven.net/prod_gameanvil/images/file_template.png" />

아래는 제공하고 있는 파일 템플릿 목록입니다.
