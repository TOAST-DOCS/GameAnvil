...
## Game > GameAnvil > 콘솔 사용 가이드 > 서버 생성하기 { #game-gameanvil-console-user-guide-creating-a-server }

<a id="gameanvil-menu-and-tab"></a>
## GameAnvil 메뉴와 탭 { #gameanvil-menu-and-tab }
...
## 서버 생성을 위한 준비 { #prepare-to-create-server }
...
## 서버 기본 정보 { #server-basic-information }
...
## 생성된 서버 확인 { #check-created-server }
...
## 동적 로그 레벨 설정 { #dynamic-log-level-setting }
...
## 생성된 노드 정보 확인 { #check-created-node-information }
