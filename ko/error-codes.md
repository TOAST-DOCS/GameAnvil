...
|                               | LOGIN_FAIL_INVALID_SUB_ID                        | 313   | 실패. 잘못된 서브 아이디                                                                                                                                       |
|                               | LOGIN_FAIL_INVALID_CHANNEL_ID                    | 314   | 실패. 잘못된 채널 아이디                                                                                                                                      |
|                               | LOGIN_FAIL_LOGINED_OTHER_SERVICE                 | 320   | 실패. 다른 서비스에 로그인되어 있음                                                                                                                                |
...
|                               | MATCH_ROOM_FAIL_MATCHING_USER_CATEGORY_EMPTY     | 914   | 실패. 매칭 룸에서 유저 카테고리 사이즈가 0일 경우                                                                                                                        |
...
|                               | NAMED_ROOM_FAIL_CONTENT                          | 1001  | 실패. 콘텐츠에서 거부됨                                                                                                                                       |
|                               | NAMED_ROOM_FAIL_ROOM_DOES_NOT_EXIST              | 1002  | 실패. 방 생성을 실패하여 방을 찾을 수 없음                                                                                                                           |
...
|                               | ALL_CHANNEL_COUNT_INFO_FAIL_INVALID_SERVICE_NAME | 1932  | 실패. 잘못된 서비스 이름                                                                                                                                       |
