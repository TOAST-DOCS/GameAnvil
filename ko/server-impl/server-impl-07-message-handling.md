...
## Game > GameAnvil > 서버 개발 가이드 > 메시지 핸들링 { #game-gameanvil-server-development-guide-message-handling }
...
## 일반 메시지 처리 { #handle-general-messages }
...
### 메시지 핸들러 구현 및 메시지와 핸들러 연결 { #implement-message-handler-and-connect-messages-to-handlers }
...
## http 요청 처리 { #handle-http-request }
...
### http 패킷 디스패처 생성 및 메시지와 핸들러 연결 { #create-http-packet-dispatcher-and-connect-messages-to-handlers }
