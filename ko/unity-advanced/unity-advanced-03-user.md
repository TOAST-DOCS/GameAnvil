...
ResultCodeLogin 상세 내용은 다음과 같습니다.
...
public async void Logout()
{
    try
    {
        ErrorResult<ResultCodeLogout, LogoutResult> result = await user.Logout();
...
ResultCodeLogout 상세 내용은 다음과 같습니다.
...
ResultCodeMatchPartyStart 상세 내용은 다음과 같습니다.
...
ResultCodeMoveChannel 상세 내용은 다음과 같습니다.
