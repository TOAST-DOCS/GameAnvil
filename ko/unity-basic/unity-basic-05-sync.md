...
## Game > GameAnvil > Unity 기초 개발 가이드 > 동기화 { #game-gameanvil-unity-basic-development-guide-synchronization }
...
### SyncController 생성 { #create-a-synccontroller }
...
## 게임 오브젝트 생성/파괴 동기화, Sync { #synchronizing-gameobject-creationdestruction-sync }
...
### 게임 오브젝트 생성 동기화 { #synchronizing-gameobject-creation }
...
### 게임 중 방에 새 유저가 입장한 경우 게임 오브젝트 생성 동기화 { #synchronizing-gameobject-creation-when-entering-a-room }
...
### 게임 오브젝트 파괴 동기화 { #synchronizing-gameobject-destruction }
...
## Transform 동기화, TransformSync { #transform-synchronization-transformsync }
...
### Transform 동기화 옵션 { #transform-synchronization-options }
...
## Animation 동기화, AnimatorSync { #animation-synchronization-animatorsync }
...
## Rigidbody2D 동기화, Rigidbody2DSync { #rigidbody2d-synchronization-rigidbody2dsync }
...
### Rigidbody2D 동기화 옵션 { #rigidbody2d-synchronization-options }
...
## Rigidbody 동기화, RigidbodySync { #rigidbody-synchronization-rigidbodysync }
...
### Rigidbody 동기화 옵션 { #rigidbody-synchronization-options }
...
## 사용자 정의 값 동기화 { #synchronizing-custom-values }

int, float, bool, string 타입의 사용자 정의 값을 동기화하는 기능을 제공합니다.

<a id="add-or-change-a-custom-value"></a>
### 사용자 정의 값 추가 또는 변경 { #add-or-change-a-custom-value }
...
### 사용자 정의 값이 최신 상태인지 확인 후 변경 { #make-sure-your-custom-values-are-up-to-date-before-making-changes }
...
### 사용자 정의 값 조회 { #lookup-custom-values }
...
### 사용자 정의 값 삭제 { #delete-custom-values }
