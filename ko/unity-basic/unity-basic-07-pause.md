...
## Game > GameAnvil > Unity 기초 개발 가이드 > 백그라운드 접속 끊김 방지 { #game-gameanvil-unity-basic-development-guide-preventing-background-disconnection }

<a id="prevent-background-disconnections"></a>
## 백그라운드 접속 끊김 방지 { #prevent-background-disconnections }
